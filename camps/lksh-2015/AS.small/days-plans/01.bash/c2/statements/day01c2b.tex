...
\contest
{ЛКШ.2015.Июль.AY.День 1: пробные ставки}%
...
\probl{2011-10}{ancestor}{B}{0.5 sec}{256 mb} % - Дано дерево, проверить за O(1), является ли одна вершина предком другой (dfs по дереву)
