...
\contest
{ЛКШ.2015.Июль.AS.День 10: структуры данных}%
...
\probl{2011-03}{permutation}{B}{0.5 sec}{256 mb} % - [просто и коротко!] Запрос = сумма на прямоугольнике.
\probl{2015-02}{distinctnum}{C}{0.5 sec}{256 mb} % - ScanLine, Количество различных чисел на отрезке в offline за [N, logN], N <= 300 000
\probl{2015-02}{distinct}{D}{0.5 sec}{256 mb}    % - Сумма различных чисел на отрезке, Обновление в точке. N <= 50 000.
