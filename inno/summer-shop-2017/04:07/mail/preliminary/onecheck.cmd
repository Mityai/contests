...
if "%2" == "" (
    ...
    if EXIST ..\%problem_name%_%1.class run -1 -t 4 -m 256M java -Xss64M -Xmx256M -cp .. %problem_name%_%1
    if EXIST ..\%problem_name%_%1.py run -t 4 -m 256M python ..\%problem_name%_%1.py
