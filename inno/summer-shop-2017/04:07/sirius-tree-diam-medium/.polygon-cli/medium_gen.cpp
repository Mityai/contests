...
int main(int argc, char* argv[])
{
    ...
    if (param==5) rand_tree(100000);
    if (param==6) binary(120);
    if (param==7) binary(99999);
    if (param==8) path(98989);
    if (param==9) rand_long(100,10000);
    if (param==10) rand_long(49999,50001);
    if (param==11) rand_long(10000,88001);
    if (param==12) rand_last(1000,8);
    if (param==13) rand_last(10000,2);
    if (param==14) rand_last(100000,3);
    if (param==15) rand_last(100000,10);
    if (param>15) rand_last(100000,100);
